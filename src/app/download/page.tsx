const files = [
  {
    name: "T1PKS_NRPS_biosynthesis_pathways.xlsx",
    description:
      "Complete curated dataset of T1PKS and NRPS biosynthesis pathways with compound, organism, module, and domain annotations.",
    size: "~2 MB",
    format: "Excel (.xlsx)",
